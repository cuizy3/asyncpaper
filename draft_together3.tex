...
\begin{lemma}[1]
For every trace $\sigma$ of the fault-tolerant circuit which is fault free and the A half begins in a valid initial state, the following three properties hold: %still kind of weird wording
\begin{itemize}
